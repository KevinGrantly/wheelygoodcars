<x-app-layout>
    <div class="py-12">
        ...
        <div class="max-w-2xl mx-wagen bg-white p-6 rounded-lg shadow-md">
            ...
            @else
                <div class="mb-6 bg-red-50 border border-red-400 text-red-700 p-4 rounded">
                    ...
                    <p>Je moet <a href="{{ route('login') }}" class="underline text-blue-600">inloggen</a> om een wagen toe te kunnen voegen.</p>
                </div>
            @endauth
