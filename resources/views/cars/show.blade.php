            ...
            <div class="md:flex">
                ...
                <div class="md:w-1/2 p-6">
                    ...
                    <div class="mt-8">
                        ...
                        <a href="{{ route('cars.export-pdf', $car) }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">
    Download als PDF
</a>
        ...
        <div class="flex">
            ...
            <div>
                <div class="flex justify-between items-center mb-1">
                    <h3 class="font-bold text-gray-800">Populaire wagen!</h3>
                ...
                <p class="text-sm text-gray-600"><strong>{{ $dailyViews }} {{ $dailyViews == 1 ? 'klant heeft' : 'klanten hebben' }}</strong> deze wagen vandaag bekeken.</p>
                <p class="text-sm text-gray-600 mt-1"><strong>{{ $potentialBuyers }} {{ $potentialBuyers == 1 ? 'persoon overweegt' : 'mensen overwegen' }}</strong> deze wagen te kopen.</p>
                <p class="text-xs text-gray-500 mt-1">
                    @if($dailyViews > 15)
                        Deze wagen is extreem populair! Wees er snel bij.
                    @elseif($dailyViews > 8)
                        Deze wagen is erg in trek! Neem snel contact op.
                    @elseif($dailyViews > 3)
                        Deze wagen trekt veel bekijks.
                    @else
                        Bekijk deze wagen nu!
                    @endif
                </p>
            </div>
        </div>
